...
import 'package:iaso/src/data/auth_repository.dart';
...
class AuthService {
  ...
  Future<User?> signIn(String email, String password, BuildContext context) async {
    try {
      ...
      await _showErrorToast(context, AppLocalizations.of(context)!.unexpected_error);
      return null;
    }
  }
  ...
  Future<User?> signUp(String email, String password, BuildContext context) async {
    try {
      ...
      if (user != null) {
        await _showSuccessToast(context, AppLocalizations.of(context)!.signup_success);
      }
      return user;
    } on FirebaseAuthException catch (e) {
      await _showErrorToast(context, _handleAuthError(e.code, context));
  ...
  Future<void> signOut(BuildContext context) async {
    try {
      ...
      await _showErrorToast(context, AppLocalizations.of(context)!.logout_error);
    }
  }
